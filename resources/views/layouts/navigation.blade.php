    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="{{ route('transaksiKembali', ['id'=>$id]) }}" :active="request()->routeIs('transaksiKembali')">
                        {{ __('Pengembalian kendaraan') }}
                    </x-nav-link>
                </div> --}}

                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('transaksiKembali', ['id' => $id])" :active="request()->routeIs('transaksiKembali', ['id' => $id])">
                        {{ __('Pengembalian Kendaraan') }}
                    </x-nav-link>
                </div> --}}
